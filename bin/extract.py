...
def main(quick = False):
    ...
    codon_hash = { 'ALA': 'A', 'ARG': 'R', 'ASN': 'N', 'ASP': 'D', 'CYS': 'C', 'GLN': 'Q', 'GLU': 'E', 'GLY': 'G', 'HIS': 'H', 'ILE': 'I', 'LEU': 'L', 'LYS': 'K', 'MET': 'M', 'PHE': 'F', 'PRO': 'P', 'SER': 'S', 'THR': 'T', 'TRP': 'W', 'TYR': 'Y', 'VAL': 'V' }   
    fseq = 1
                             ...
                             for codon in segment:
                                 if len(codon) ==3:
                                    try:
                                       ...
                                       bugger.write(file + ' KeyError codon ' + codon+"\n")
                                       continue
                                 else:
                                     sequence+= codon+ " "
